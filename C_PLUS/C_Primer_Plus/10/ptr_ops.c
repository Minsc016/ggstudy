/*************************************************************************
	...
	> Author: Crow
	> Mail: qnglsk@163.com 
	> Created Time: Mon Aug 31 19:21:08 2020
 ************************************************************************/

#include<stdio.h>

// prt_ops.c -- pointer operations
...
int main(void)
{
	...
	ptr2 = &urn[2];			//ditto
							//dereference a pointer and table the address of a pointer
							//
	...
	printf("ptr1 = %p, ptr2 = %p\n", ptr1, ptr2);	// subtract one pointer from another
