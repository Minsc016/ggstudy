...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','219tt.py',30),
  ('expr -> expr MINUS term','expr',3,'p_expr','219tt.py',31),
  ('expr -> term','expr',1,'p_expr_term','219tt.py',40),
  ('term -> term TIMES factor','term',3,'p_term','219tt.py',46),
  ('term -> term DIVIDE factor','term',3,'p_term','219tt.py',47),
  ('term -> factor','term',1,'p_term_factor','219tt.py',56),
  ('factor -> NUM','factor',1,'p_factor','219tt.py',62),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','219tt.py',68),
]
